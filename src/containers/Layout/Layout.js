...
import { generateImage } from "../../predict";
    ...
    return (
      <div>
        <Container
          fluid
          style={{
            display: this.state.generationStatus === 0 ? "block" : "none",
          }}
        >
          ...
          <Row className="margin">
            ...
            >
              ...
              <h5><a href="https://github.com/Lempickax/Glaucomark/tree/master/sample"  target="_blank">
                Try with samples
              </a>
</h5>
              <input
                label={
                  this.state.uploaded ? "Change the image" : "Upload an image"
                }
            ...
            <Col xs="12" md="8" lg="6" style={{ textAlign: "center" }}>
              ...
              >
                <div>
                  ...
                  <p style={{ textAlign: "left" }}>
                    While the predicting model had been validated with a high
                    accuracy, the training dataset still lacks variety.{" "}
                  </p>
                  <p style={{ textAlign: "left" }}>
                    Thus, the author of this site makes no claims, promises or
                    guarantees about the testing results, and expressly
                    disclaims liability for any potential errors.
                  </p>
                ...
                <div>
                  <PressButton btnType="Success" clicked={this.generate}>
                    Agree
                  </PressButton>
                  <PressButton
                    btnType="Danger"
              ...
              <Button variant="primary" onClick={this.operateHandler}>
                Predict
              </Button>
            </Col>
            <Col />
        ...
        <div
          className="overlay"
          style={{
            display: this.state.generationStatus === 1 ? "block" : "none",
          }}
        >
          <div
            style={{
            ...
            <Container fluid>
              <Row>
                ...
                <Col xs="12" md="8" lg="6" style={{ textAlign: "center" }}>
                  ...
                  <p>
                    This may take 15 to 30 seconds depending on your device.
                  </p>
                </Col>
                <Col />
              </Row>
        ...
        <div
          className="overlay"
          style={{
            display: this.state.generationStatus === 2 ? "block" : "none",
          }}
        >
          <Container fluid>
            <Row className="margin">
